...
Fixed-rate periods of 1–3 years are standard, after which the loan resets to EIBOR-linked variable. Factor in the 0.25% mortgage registration fee on the loan amount at DLD. On a AED 650,000 purchase with 75% LTV, the mortgage registration fee is approximately AED 1,220.
