...
The principle is simple: spend 183 or more days in the UAE in a calendar year, and you meet the primary day-count test for UAE tax residency. The practice is harder. Common complications include:
...
**Multiple short trips**: Someone who takes 20 or 30 short trips to the UAE across a year accumulates days in a fragmented pattern. Without a contemporaneous log, reconstructing the exact count from memory at year-end (or two years later during an audit) is unreliable.
...
The UAE residency framework introduced in Ministry of Finance Decision No. 27 of 2023 also contains a 90-day test and a domicile test. These are covered in detail in the [183-day rule hub guide](/guides/uae-tax-residency-183-day-rule/).
...
- Many people count from their visa issuance date or Emirates ID activation date, which does not align with the calendar year.
- If you moved to the UAE in September, your first calendar year may include fewer than 183 UAE days even if you spent every subsequent day in the UAE.
- Your home country may use a different tax year (UK tax year runs April to April; Australian tax year runs July to June). Day-count tests in different jurisdictions may overlap in unexpected ways.
...
The FTA reviews applications and may request supplementary documents. Applications are submitted online via tax.gov.ae. Processing times vary; allow adequate lead time if you need the TRC by a specific deadline, for example a home-country tax filing deadline.

There is a fee for TRC issuance. Verify the current fee schedule on the FTA portal.
