---
title: "CRS and FATCA for UAE Bank Accounts: Expat Guide"
...
The UAE is not a tax haven in the traditional sense. Since committing to the OECD's Common Reporting Standard, the UAE has built a financial information exchange framework that provides account data to over 100 foreign tax authorities. This is a significant shift from the perception of UAE banking as opaque.
...
CRS is an OECD multilateral standard for the automatic exchange of financial account information between participating jurisdictions. Under CRS:
...
The UAE signed the OECD Multilateral Competent Authority Agreement and implemented CRS reporting domestically. UAE financial institutions have reported CRS data since 2018 for accounts held by residents of other CRS jurisdictions.
...
**FBAR reporting obligation (US persons):** Separately from FATCA, US persons with foreign financial accounts aggregating more than USD 10,000 at any point during a calendar year must file an FBAR (FinCEN Form 114) with the Financial Crimes Enforcement Network. This applies to UAE bank accounts. Non-compliance penalties can be significant; consult a US expat tax specialist.
...
The UAE exchanges CRS data with all jurisdictions that are: (i) participating in CRS; and (ii) have activated an exchange relationship with the UAE. As of 2026, this includes most of the EU member states, UK, Australia, Canada, India, Singapore, South Africa, and many others.
