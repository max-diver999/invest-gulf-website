...
If you remain French tax resident, IFI applies to Dubai real estate above the EUR 1.3 million threshold on your worldwide property portfolio. Dubai's zero personal income tax does not remove IFI by itself. Establishing genuine UAE tax residency with 183+ days in country, primary economic ties, and proper DGFiP notification is the path French advisors use to move Dubai units outside the IFI base, subject to individual facts and treaty analysis with a French counsel.
