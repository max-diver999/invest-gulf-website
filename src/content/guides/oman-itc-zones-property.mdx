...
<TldrBlock text="Foreign freehold = ITC zones only. Gross yields 4–6%. OMR 250K investor residency (confirm current official rules), separate application. Acquisition costs 3–5%. Plan 5+ year hold for illiquid resale." />
