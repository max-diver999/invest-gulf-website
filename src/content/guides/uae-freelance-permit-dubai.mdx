...
The [UAE Residency Visa Types Guide](/guides/uae-residency-visa-types-guide/) explains how a freelance permit residence visa compares to employment visas, investor visas, and the Green Visa in terms of renewal rules, family sponsorship, and exit requirements. For a complete picture of UAE residency options — including the Green Visa pathway that does not require an employer — see the [UAE Green Visa Guide](/guides/uae-green-visa-guide/).
