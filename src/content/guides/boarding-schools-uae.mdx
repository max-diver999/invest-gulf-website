...
## Cranleigh Abu Dhabi and the main boarding options
...
Full-board packages typically land AED 130,000 to 175,000 per child per year once activities, exams, and travel home are included. Day places cost less but still run AED 65,000 to 115,000 at premium schools.
...
## ADEK and KHDA: what regulators check for boarders
...
## When boarding beats day school (and when it does not)
...
## Admissions timeline and school visits

Apply 12 to 18 months before Year 7, Year 9, or Year 12 entry at Cranleigh and other premium schools. March applications for the following September are tight; registering interest in the prior autumn is safer.
...
## How boarding changes where you can live

Boarding removes the need to rent next to campus. This changes your property calculations in meaningful ways:
...
## Sample schooling scenarios

| Profile | Typical choice | Housing note |
|---|---|---|
| Rotating oil and gas parent | Cranleigh full board | Can live in Al Raha or Reem, not Saadiyat |
| IB-focused family | SISD boarding | Urban Dubai base, shorter commute to DIFC |
| UK expat, UCAS focus | Cranleigh or UK boarding | UAE boarding saves guardian and flight costs |
| Primary-age children | Day school only | Boarding rarely starts before Year 9 |

## Summary before you enroll
