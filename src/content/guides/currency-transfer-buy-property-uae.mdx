...
<TldrBlock text={"AED = USD peg, dollar buyers simple; others watch spread. Open UAE account → compare FX quote → wire with SPA reference → retain MT103. India: LRS USD 250K/person/year. Never courier cash. Align transfer 7 days before trustee. Hubs: bank account · buying costs · step-by-step"} />
