...
## Uae Green Visa — applicant scenarios

**Scenario A — green first filing:** Start medical tests and document attestation 3–4 weeks before travel for green. Do not sign a 12-month lease until green category is confirmed with your PRO.
...
## Uae Green Visa — visa risks

- Salary thresholds and profession lists behind Uae Green Visa change without wide announcement. Reconfirm with MOI/GDRFA the week you file.
- Visit-to-work status changes require in-country processing. Working on a tourist visa while pursuing Uae Green Visa is a serious violation.
- Medical fitness failures delay the whole family pipeline for Uae Green Visa. Pre-check conditions with approved clinic lists.
- Attestation mismatches on marriage and birth certificates are the most common rejection cause for Uae Green Visa filings.
...
Pillar: Green Visa categories and baseline eligibility — read before freelancer or skilled-worker spokes. Use internal links to sibling guides when your question spans multiple intents — do not treat overlapping slugs as duplicate content.
