...
## The five ADEK rating tiers explained

ADEK uses five public tiers from Outstanding down to Weak, and each tier signals both quality and how much the school can raise fees in the next academic year. Use the tier as a filter, then read the full inspection PDF before you commit to a school or a lease tied to a catchment.
...
## How ADEK ratings link to school fee increases
...
## How often ADEK inspects schools and what triggers a revisit

Most Abu Dhabi private schools face a full ADEK inspection about every two years, while Acceptable and Weak schools often see extra visits in the same academic year until inspectors sign off on an improvement plan. Outstanding schools with strong self-evaluation may qualify for a longer gap, but the published inspection date on adek.gov.ae is what you should trust, not marketing claims.
...
Inspectors score schools across attainment, progress, teaching, wellbeing, and leadership, and the written report explains where each domain landed.
...
ADEK ratings give you a useful starting screen. Shortlist schools rated Outstanding or Very Good within your curriculum preference and approximate location across Abu Dhabi, Al Ain, or Al Dhafra. This typically reduces 200-plus licensed private schools to a manageable shortlist of 5 to 10.
...
## Key differences between ADEK and KHDA for relocating families
