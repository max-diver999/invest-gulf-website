...
## Dubai Maternity Costs — planning scenarios

**Scenario A — short GCC assignment:** Keep exit costs low with flexible lease terms, minimal furniture, and a documented visa cancellation path relevant to Dubai Maternity Costs.
...
<InlineCta
  ...
  ctaId="inline_cta_dubai-maternity-cost"
/>
