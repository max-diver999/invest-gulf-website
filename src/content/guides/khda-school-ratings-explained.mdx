...
KHDA (Knowledge and Human Development Authority) is Dubai's regulator for private schools. Its Dubai Schools Inspection Bureau (DSIB) publishes the ratings families quote in admissions brochures, and those ratings directly shape annual fee increase permissions. If you are relocating with children, the rating is not decorative: it signals inspection quality, fee trajectory, and how much scrutiny the school faces between cycles.
...
KHDA publishes five bands: Outstanding, Very Good, Good, Acceptable, and Weak. The headline rating reflects the weakest inspection domain, so a single weak safeguarding or leadership score can cap the whole school. Use the tier as a filter, then read the domain breakdown in the full PDF.
...
For the 2025-26 academic year, KHDA linked maximum tuition increases to each school's latest rating. Caps apply to headline tuition; schools may still adjust buses, uniforms, trips, and tech levies under their own policies, so your all-in bill can rise faster than the tuition cap alone.
...
Most Dubai private schools face a full DSIB inspection on a rolling two-year cycle, with shorter or unannounced visits for schools rated Acceptable or Weak. Outstanding and Very Good schools with strong self-evaluation may move to a three-year cycle until a safeguarding or results issue triggers an early visit.
...
Inspectors score six domains on each visit. The published rating cannot exceed the weakest domain, which is why a strong exam school can still miss Outstanding if wellbeing or leadership lag.
...
Ratings do not replace a school visit, parent references, or your child's specific needs. They also lag reality: leadership changes, a weak GCSE cohort, or a sudden intake surge may not appear until the next inspection cycle.

A higher band does not guarantee your child will thrive in that curriculum track, and a Good rating does not mean a school is unsafe. Ratings rarely capture commute pain at 7:15 to 7:45 AM, sibling seat availability, or whether the school's culture fits your family. Pair KHDA data with [school fees vs property budget in Dubai](/guides/school-fees-vs-property-budget-dubai/) when you map neighbourhoods.
