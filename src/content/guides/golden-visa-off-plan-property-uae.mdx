...
Spoke: Golden Visa eligibility on off-plan tickets — visa intent, not general off-plan process. Use internal links to sibling guides when your question spans multiple intents — do not treat overlapping slugs as duplicate content.
...
## Golden Visa Off Plan Property Uae — applicant scenarios
