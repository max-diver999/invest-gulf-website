...
Expats face about 60 to 65 percent maximum LTV on second and subsequent investment homes, so plan 35 to 40 percent down. First homes can reach 80 percent LTV. Central Bank rules intentionally require more equity per additional mortgaged unit.
...
Some UAE banks include projected rent at 60 to 80 percent of market, others ignore rent and stress personal salary only. Ejari history on existing units is the strongest evidence when you add a second investment loan.
