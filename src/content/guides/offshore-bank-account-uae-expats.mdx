...
In UAE conversations, "offshore" almost always means a DIFC or ADGM account, not a hidden tax-free pot. CRS reporting applies everywhere. The practical split is legal regime (common law in the free zones) versus everyday retail banking onshore.
...
DIFC and ADGM are separate legal jurisdictions inside the UAE with English common-law courts and their own regulators (DFSA and FSRA). Onshore accounts sit under UAE Central Bank rules. All three report under CRS if you remain tax resident abroad.
...
DIFC private banking fits high balances and complex wealth needs, not salary accounts or small transfers. Minimum mandates often start near AED 500,000 to AED 1,000,000, with USD 1M+ common for full private banking.
...
ADGM suits Abu Dhabi-focused investors and sovereign-linked wealth flows. FAB International and ADCB Private lead FSRA-licensed private banking on Al Maryah Island.
...
UAE banks, including every DIFC and ADGM institution, exchange account data with treaty partners under CRS. There is no UAE account type that avoids reporting while you stay tax resident elsewhere.
...
US persons must file FBAR and Form 8938 even with UAE residency. UAE banks identify US account holders and report under the FATCA inter-governmental agreement.
...
Once you become UAE tax resident under the 183-day rule or centre-of-life test, CRS reporting shifts to the UAE rather than your former home country. That only works with genuine relocation, not a mailbox address.
...
Most expats should start onshore for salary, rent, cards, and mortgages. Add DIFC or ADGM private banking only when balances and complexity justify the fees.
...
Expect passport, proof of address, 12 months of bank statements, a source-of-funds narrative, and your home-country tax ID. Private banks usually require an in-person meeting.
...
Onshore retail accounts for employed residents often clear in 5 to 10 business days once Emirates ID is ready. Private banking in DIFC or ADGM typically needs 3 to 6 weeks after the relationship meeting and compliance review.

## What mistakes do expats make with UAE banking?

Assuming CRS exemption in a free zone, opening only a private bank without a daily AED account, or failing to obtain UAE tax residency before claiming non-residence at home are the recurring errors Invest Gulf sees on banking files.
