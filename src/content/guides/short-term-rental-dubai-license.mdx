...
**DET (Department of Economy and Tourism) licenses all Dubai stays under 12 months** as holiday homes. There is no informal Airbnb grey zone: permits, Civil Defence checks, and guest registration are mandatory.
...
- **Peak season (Nov to Mar):** Maximize rates, expect 85-95% occupancy
- **Shoulder season (Apr to May, Sep to Oct):** Balance rate and occupancy
- **Low season (Jun to Aug):** Focus on occupancy with competitive pricing
