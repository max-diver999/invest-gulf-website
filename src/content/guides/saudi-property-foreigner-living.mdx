...
<TldrBlock text={"Foreigners cannot buy property anywhere in Saudi Arabia like Dubai freehold. Law M/14 (2021) limits non-Saudi ownership to designated zones, lists and project eligibility evolve through 2026 (confirm current official rules). Buying does not auto-grant iqama or Premium Residency (~SAR 4M track (confirm current official rules)), separate programmes. Owner life still needs schools, compound culture, conservative public norms and tolerance for illiquidity. Rent-first stays valid: model spend in Riya"} />
