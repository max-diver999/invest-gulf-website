...
<TldrBlock text="Law M/14 = designated zones only. REGA portal is source of truth. NEOM, Red Sea, Qiddiya, Diriyah, ROSHN select, phased Riyadh/Jeddah (confirm current official rules). Premium Residency is separate. Verify before deposit." />
...
<InlineCta
  ...
  ctaId="inline_cta_saudi-property-desig"
/>
