...
- FX spreads on international transfers are not the tightest — many expats use a separate [currency transfer service for large UAE property transactions](/guides/currency-transfer-buy-property-uae/) rather than the bank rate.
