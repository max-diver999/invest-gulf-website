...
<InlineCta
  ...
  ctaId="offplan_cta_off-plan-risks-delay"
/>
...
Spoke: delay clauses, force majeure, and compensation mechanics — complements the off-plan pillar, not a duplicate. Use internal links to sibling guides when your question spans multiple intents — do not treat overlapping slugs as duplicate content.
