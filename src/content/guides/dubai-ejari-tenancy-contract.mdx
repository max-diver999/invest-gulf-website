...
Ejari is Dubai's official tenancy-registration system: the registered contract records the landlord, tenant, property, rent and term. Dubai Land Department's tenancy guide and unified contract make the signed record central to the lease relationship. **Insider tip:** foreign buyers should match every identity and unit field precisely, then confirm the current AED 220 charge before submitting.

Dubai Land Department's tenancy guide describes a tenancy contract as the legal document governing the landlord and tenant relationship, while the unified contract identifies the parties, premises, rent, term and agreed obligations. An Ejari record should therefore be treated as evidence that must match the executed contract, not as a separate informal form. Before signing, compare the landlord or authorised signatory, unit number, annual rent, payment schedule, start date and end date against the title or property documents. Keep the signed contract, registration output and payment evidence together. If an entry is wrong, ask for a correction before relying on it for a utility, residency or dispute process. Check the current AED 220 planning charge before submitting. This guidance is based on Dubai Land Department documents and is not legal advice.

The unified Dubai tenancy contract sets a defined contract term and records rent and payment details, which makes the document useful when a tenant needs to prove what was agreed. A tenant should not assume that an agent's email, a verbal assurance or an advertising listing overrides the completed contract. Check the premises description, use of the property, maintenance allocation, deposit, notices and signatures before registration. The Dubai Land Department guide is the authoritative starting point for the registration process, while a dispute or unusual clause may require qualified local legal advice. For a family move, complete this document check before timing DEWA, school applications or visa paperwork. Save dated copies in an accessible folder for the whole tenancy. Confirm the current AED 220 planning charge before filing. Review official updates before renewal.

| Tenant checklist item | Why it matters |
| --- | --- |
| Parties and unit | Must match the signed contract |
| Rent and payments | Records the agreed AED amount and schedule |
| Term and notices | Defines the tenancy period |
| Registration output | Supports the completed Ejari record |

- Use the Dubai Land Department guide and unified contract as the source checklist.
- Confirm the AED 220 planning charge at the official service point before payment.
...
If that decision is on your list, [Moving Pets to Dubai](/guides/pet-relocation-dubai/) covers it in detail. Buyers comparing this often read [Shipping Household Goods to Dubai](/guides/shipping-household-goods-dubai/) next.

<InlineCta
 headline="Need help choosing a Dubai home that fits your plans?"
 subtext="Get a practical shortlist based on your budget, commute, and residency goals."
 buttonText="Get Your Dubai Shortlist"
 buttonHref="/invest-dubai-property/"
 ctaId="ejari_cta_dubai-tenancy-contract"
/>
