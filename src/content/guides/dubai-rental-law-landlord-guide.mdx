...
<CommercialBridge variant="money" ctaId="bridge_money_cta_dubai-rental-law-landlor" />
...
## Dubai Rental Law Landlord — planning scenarios

**Scenario A — short GCC assignment:** Keep exit costs low with flexible lease terms, minimal furniture, and a documented visa cancellation path relevant to Dubai Rental Law Landlord.
