...
<TldrBlock text="** REGA designated zone (confirm current official rules). Zero yield until handover. No resale market. 5–10+ year hold. Premium Residency separate (confirm current official rules). REGA verification mandatory." />
...
<InlineCta
  ...
  ctaId="buy_cta_neom-property-invest"
/>
