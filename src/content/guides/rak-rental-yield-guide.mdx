...
RAK VPI gross near 5.3-5.4% typically trails Dubai mid-market 7.5-9.2% gross, but +12.7% VPI price growth can push total return near 17% when 4.5% net yield is stacked with appreciation. We still discount Al Marjan liquidity risk in this market versus JVC's thicker exit book.
...
Established Al Hamra and Mina Phase 1-3 stock typically plans at 5-7% vacancy, while Al Marjan pre-Wynn needs 8-12% because the rental book is thinner than Dubai mid-market. We reject 0% vacancy assumptions in this market because they overstate net yield by 1 to 2 points.
...
RAK short-term rental typically adds a 20-30% gross premium over long-term lets in the best Al Hamra cases, but management fees of 15-20% and seasonal vacancy narrow the net advantage. We underwrite long-term first in this market and treat STR as optional enhancement only.
...
RAK total return can look competitive on paper when 4.5% net yield meets +12.7% VPI appreciation, but Al Marjan appreciation is forward-priced and exit liquidity is thinner than Dubai. We require a realistic resale assumption in this market before a 10-year model is treated as bankable.
...
Yield claims built on 2022 launch prices, zero vacancy, or post-Wynn rents presented as current income typically fail underwriting within the first review cycle. We pause any Al Marjan file quoting 8% gross near peak PSF in this market until rent and price are both evidenced in writing.
