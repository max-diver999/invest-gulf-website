...
<TldrBlock text="REGA zones only (confirm current official rules). Aramco employment thesis. Est. gross 4–5.5% (confirm current official rules). Limited inventory. Niche Saudi allocation." />
