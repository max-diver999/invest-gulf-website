...
<TldrBlock text="REGA zones only (confirm current official rules). ROSHN, Diriyah, phased urban. Est. gross 4–6% (confirm current official rules). Premium Residency separate. 5–10 year hold. REGA verify mandatory." />
