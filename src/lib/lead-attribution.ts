import {
  ...
  type ExternalAiSource as DetectedExternalAiSource,
} from './external-ai-sources';

export type ExternalAiSource = DetectedExternalAiSource | '';
...
const STORAGE_KEYS = {
  landingPage: 'ig_landing_page',
  firstReferrer: 'ig_first_referrer',
